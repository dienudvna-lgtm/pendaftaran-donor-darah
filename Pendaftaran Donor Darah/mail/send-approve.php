...
$required = ['id', 'full-name', 'email', 'phone', 'blood-type', 'donation-date', 'location'];
...
$subject = 'BloodConnect - Registration Confirmation';
$message = "Hello {$body['full-name']},<br><br>Congratulations!<br><br>Your blood donation registration has been approved.<br><br>Donation Information:";
$details = [
    'Name' => $body['full-name'],
    'Donation Date' => $body['donation-date'],
    'Donation Location' => $body['location'],
];
